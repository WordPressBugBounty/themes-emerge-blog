 ...
 * @return array
 */
function emerge_blog_body_classes( $classes ) {
...
add_filter( 'body_class', 'emerge_blog_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function emerge_blog_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'emerge_blog_pingback_header' );

/**
 * emerge_blog Excerpt Length
 *
...
if ( ! function_exists( 'emerge_blog_excerpt_length' ) ) :
   ...
   */
  function emerge_blog_excerpt_length( $length ) {
...
add_filter( 'excerpt_length', 'emerge_blog_excerpt_length', 999 );
